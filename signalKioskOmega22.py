...
def DispMAG ():
	segment.clear()
	segment.set_digit_raw(0,0x33)#37,D4
	segment.set_digit_raw(1,0x27)#37,D4
...
def main():
	...
	while True:
		...
		#print('SIGNALKHOST is '+ SIGKHOST +'')
		#print('SIGNALKPORT is '+ str(SIGKPORT) +'')
